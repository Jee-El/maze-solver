...
class MazeSolver:
    ...
    def solve_with_bfs(self, start=None, end=None):
    ...
    def __bfs(self, start, end):
        ...
        while queue:
            ...
            # Uncomment the lines below to see the live version
            # self.__clear_screen()
            # self.maze.draw_path(path)
            # sleep(1)
    ...
    def __dfs(self, start, end, queue, visited_vertices, explored_states = 0):
        if not queue:
            raise Exception('No Solution')
